                ...
                <div class="col-md-12">
                    <div class="table-container table-responsive">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ $formborrow->nama_peminjam }}</td>
                                    <td>{{ $formborrow->mulai }}</td>
                                    <td>{{ $formborrow->selesai }}</td>
                                    <td>{{ $formborrow->ktm }}</td>
                                    <td>{{ $formborrow->genre->nama }}</td>
                                    <td>{{ $formborrow->buku->title }}</td>
                                    <td>{{ $formborrow->petugas->nama }}</td>
                                    <td>{{ $formborrow->status_peminjam }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
