              ...
              <div class="card-body">
                <form action="{{ route('peminjaman.store') }}" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" name="nama_peminjam" id="nama_peminjam" class="form-control col-md-8" required>
                  </div>
                  <div class="form-group row">
                    <label for="mulai" class="col-md-4">Mulai</label>
                    <input type="date" name="mulai" id="mulai" class="form-control col-md-8" required>
                  </div>
                  <div class="form-group row">
                    <label for="selesai" class="col-md-4">Selesai</label>
                    <input type="date" name="selesai" id="selesai" class="form-control col-md-8" required>
                  </div>
                  <div class="form-group row">
                    <label for="ktm" class="col-md-4">Ktm</label>
                    <input type="text" name="ktm" id="ktm" class="form-control col-md-8" required>
                  </div>
                  <div class="form-group row">
