            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form_container">
                        ...
                        <form action="{{ route('formbuy.store') }}" method="POST" id="contactForm">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="tanggal">Tanggal</label>
                                <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal') }}" data-sb-validations="required" />
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="nama_pembeli" name="nama_pembeli" value="{{ old('nama_pembeli') }}" type="text" placeholder="Nama Pembeli" data-sb-validations="required" />
                                <div class="invalid-feedback" data-sb-feedback="nama_pembeli:required">Nama Pembeli is required.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="telefon">No Telefon</label>
                                <input class="form-control" id="telefon" name="telefon" value="{{ old('telefon') }}" type="text" placeholder="No Telefon" data-sb-validations="required" />
                                <div class="invalid-feedback" data-sb-feedback="telefon:required">No Telefon is required.</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="harga_buku">Harga Buku</label>
                                <select name="harga_buku" id="harga_buku" class="form-control" required>
                                    <option value="" hidden>Pilih Harga Buku</option>
                                    @foreach ($buku as $buk)
                                    <option value="{{ $buk->id }}">{{ $buk->harga }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback" data-sb-feedback="harga_buku:required">Harga Buku is required.</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="statusPembelian:required">Status Pembelian is required.</div>
                            </div>
                            <div class="btn_box">
